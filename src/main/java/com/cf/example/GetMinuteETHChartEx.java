...
/**
 * Created by D.Aleksandrov on 29.06.2017.
 */
public class GetMinuteETHChartEx {
    ...
    public static void main(String[] args)
    {
        ...
        new GetMinuteETHChartEx().run(propertiesFileName);
    }
    ...
    public void run(String propertiesFileName)
    {
        ...
        Long yesterdayEpochSecond = ZonedDateTime.now(ZoneOffset.UTC).minusMinutes(5).toEpochSecond();
        List<PoloniexChartData> btcDailyChartData = service.returnChartData(PoloniexExchangeService.BTC_ETH_CURRENCY_PAIR,
                PoloniexExchangeService.FIVE_MINUTES_TIME_PERIOD, yesterdayEpochSecond);
