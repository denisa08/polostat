...
public interface ExchangeService
{
    ...
    public final static String BTC_ETH_CURRENCY_PAIR = "BTC_ETH";
    ...
    public final static Long ONE_MINUTES_TIME_PERIOD = 60L;
    public final static Long FIVE_MINUTES_TIME_PERIOD = 300L; //300 000
